  ...
  return (
    <div className="flex flex-col space-y-2">
      <MenuItem
        isOpen={isOpen}
        setIsOpen={setIsOpen}
        title={"Creator lookalike"}
        active={filters?.creator_lookalikes ? true : false}
      />
      {isOpen ? (
        <div className="bg-white p-2 grid grid-cols-1 w-72">
          <Select
            ...
            showSearch
            onSelect={(e) => {
              setFilters({ ...filters, creator_lookalikes: "@" + "" + e });
            }}
            className="w-full"
...
export default CreatorLookAlikeFilter;
