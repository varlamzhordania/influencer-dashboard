...
const AudienceBrandAffinity = ({ brands, filters, setFilters }) => {
  ...
  return (
    <div className="flex flex-col space-y-2">
      <MenuItem
        ...
        active={filters?.audience_brand_affinities ? true : false}
      />
      {isOpen ? (
        <div className="bg-white p-2 grid grid-cols-2 space-x-2 w-52">
          <Select
            ...
            value={filters?.audience_brand_affinities}
            ...
            onChange={(e) => {
              setFilters({ ...filters, audience_brand_affinities: e });
            }}
