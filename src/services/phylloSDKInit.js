...
class PhylloSDK {
  ...
  async openPhylloSDK() {
    if (typeof window.PhylloConnect === 'undefined') {
      console.error('PhylloConnect is not defined. Make sure the library is loaded.');
      return; // Exit the function if PhylloConnect is not defined
    }
